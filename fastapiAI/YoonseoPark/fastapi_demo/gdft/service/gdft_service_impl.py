...
class GDFTServiceImpl(GDFTService):
    ...
    def gdftTest(self):
        ...
        traininigParameter = self.gdftRepository.configTrainingParameter()
        trainer = self.gdftRepository.configTrainer(model, traininigParameter, needToTrainDataset, tokenizer)
    ...
    def gdftUserRequestTest(self, text):
        ...
        inputList = tokenizer.encode_plust(text, return_tensors='pt', padding=True)
